...
* Evaluate seasonal and category-wise trends
...
* Interactive filters (Region, Category, Season, Shipping Mode)
...
* Sales peak in later months, especially around Month 10
* Seasonal variation observed between sales and profit

### 👥 Customer Insights

* Regular customers contribute the highest share of revenue
* New customers contribute less, highlighting the importance of retention

### 📦 Product & Quantity Insights

* Most customers purchase 2–3 units per order
* Low-volume transactions dominate overall sales

### 🚚 Shipping Insights

* Overnight shipping generates the highest profit
* Customers are willing to pay a premium for faster delivery

### 🌸 Seasonal Insights

* Spring has the highest sales volume
* Fall delivers higher profitability
* High sales do not always result in high profit

### 🛍️ Category Insights

* Clothing is the top-selling category
* Books rank as the second highest-selling category
